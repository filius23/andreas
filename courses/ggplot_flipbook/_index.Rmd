...
#### [Source code auf github `r fontawesome::fa("github")`](https://github.com/filius23/andreas/tree/main/courses/ggplot_flipbook)
[`r fontawesome::fa("creative-commons")` `r fontawesome::fa("creative-commons-by")` `r fontawesome::fa("creative-commons-nc")`](https://creativecommons.org/licenses/by-nc/4.0/)
...
christmas_trees <- 
  readxl::read_xlsx(christmas_trees_file) %>% 
    rename(
      ...
      jahr = Year) %>% 
  mutate(anz_baeume= anz_baeume/100000) 
